      ...
      <section className="max-w-7xl mx-auto px-4 pt-6 pb-4">
        <div className="flex flex-col lg:flex-row gap-4 items-start">
          ...
          <div className="w-full lg:w-1/3 lg:pl-2">
            <h2 className="text-base font-extrabold text-ink border-b-2 border-ink pb-2 mb-4">Top Stories</h2>
      ...
      <section className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
          <div className="lg:col-span-3 space-y-10">
            <div>
              <h2 className="text-lg font-extrabold text-ink border-b-2 border-ink pb-2 mb-6">Latest News</h2>
          ...
          <aside className="space-y-8">
            <div className="sticky top-24 space-y-8">
              {opinions.length > 0 && (
                <div>
                  <h3 className="text-base font-extrabold text-ink border-b-2 border-ink pb-2 mb-4">Opinion & Analysis</h3>
              ...
              {editorsPicks.length > 0 && (
                <div>
                  <h3 className="text-base font-extrabold text-ink border-b-2 border-ink pb-2 mb-4">Editor's Picks</h3>
                  <div className="space-y-4">
