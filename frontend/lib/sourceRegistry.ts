...
const sources: Source[] = [
  ...
  // Presidency Agencies — Tier 2 (high-profile / frequently newsworthy)
  {
    name: 'NDLEA',
  ...
  // Federal Ministries — Tier 3 (not already covered in Tier 1/2)
  {
  ...
  },
  {
    ...
    url: 'https://communications.gov.ng',
    pressPath: '/news/',
    tier: 3, level: 'federal', category: 'technology',
    strategy: 'html', selector: 'article h2 a, .entry-title a, h3 a',
    active: true,
  },
  {
  ...
  },
  {
    ...
    url: 'https://regionaldevelopment.gov.ng',
    pressPath: '/news/',
    tier: 3, level: 'federal', category: 'nigeria',
    strategy: 'html', selector: 'article h2 a, .entry-title a, h3 a',
    active: true,
  ...
  },
  {
    ...
    url: 'https://solidminerals.gov.ng',
    pressPath: '/news/',
    tier: 3, level: 'federal', category: 'economy',
    strategy: 'html', selector: 'article h2 a, .entry-title a, h3 a',
    active: true,
  },
  {
    ...
    url: 'https://sports.gov.ng',
    pressPath: '/news/',
    tier: 3, level: 'federal', category: 'sport',
    strategy: 'html', selector: 'article h2 a, .entry-title a, h2 a',
    active: true,
  },
  {
    name: 'Ministry of Steel Development',
    url: 'https://steel.gov.ng',
    pressPath: '/news/',
    tier: 3, level: 'federal', category: 'economy',
    strategy: 'html', selector: 'article h2 a, .entry-title a, h3 a',
    active: true,
  ...
  {
    name: 'Ministry of Art, Culture, Tourism and Creative Economy',
  ...
  },
  {
    ...
    url: 'https://budgetplanning.gov.ng',
    pressPath: '/news/',
    tier: 3, level: 'federal', category: 'economy',
    strategy: 'html', selector: 'article h2 a, .entry-title a, h3 a',
    active: true,
  ...
  {
    name: 'Revenue Mobilisation Allocation and Fiscal Commission',
    url: 'https://rmafc.gov.ng',
    pressPath: '/news/',
    tier: 3, level: 'federal', category: 'economy',
    strategy: 'html', selector: 'article h2 a, .entry-title a, h2 a',
    active: true,
